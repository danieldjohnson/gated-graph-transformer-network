...
class EdgeStateUpdateTransformation( object ):
    ...
    def __init__(self, input_width, graph_spec, dropout_keep=1):
        ...
        self._update_stack = LayerStack(self._process_input_size, 2*graph_spec.num_edge_types, [self._process_input_size], activation=identity, bias_shift=-3.0, name="edge_update", dropout_keep=dropout_keep, dropout_input=False)
    ...
    def process(self, gstate, input_vector, dropout_masks=Ellipsis, bin_choice_act=T.nnet.sigmoid):
        """
        ...
        Params:
            ...
            bin_choice_act: Function mapping R -> (0,1) used to pick set and clear
        """
        ...
        flat_result = bin_choice_act(flat_result)
